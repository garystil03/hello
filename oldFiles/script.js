document.addEventListener("DOMContentLoaded", function() {
    ...
    cell1.style.minHeight = "20px"; // Minimum row height
    ...
    cell3_3.textContent = "Astrolabes for use on Mercury, Venus, Mars ... and even PlutoGary James Stilwell MDastrolabe.sketches@gmail.com https://astrolabe-sketches.site";
    cell3_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 4
    var row4 = table.insertRow();
    var cell4_1 = row4.insertCell();
    cell4_1.textContent = "Row 4 text";
    cell4_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 5
    var row5 = table.insertRow();
    var cell5_1 = row5.insertCell();
    cell5_1.textContent = "Row 5 text";
    cell5_1.style.minHeight = "20px"; // Minimum row height
    ...
    img6_1.onload = function() {
        setImageWidth(img6_1, TABLE_WIDTH);
    };
    cell6_1.appendChild(img6_1);
    cell6_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell7_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 8
    var row8 = table.insertRow();
    var cell8_1 = row8.insertCell();
    cell8_1.textContent = "Row 8 text";
    cell8_1.style.minHeight = "20px"; // Minimum row height
    ...
    img9_1.onload = function() {
        setImageWidth(img9_1, TABLE_WIDTH);
    };
    cell9_1.appendChild(img9_1);
    cell9_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell10_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 11
    var row11 = table.insertRow();
    var cell11_1 = row11.insertCell();
    cell11_1.textContent = "Row 11 text";
    cell11_1.style.minHeight = "20px"; // Minimum row height
    ...
    img12_1.onload = function() {
        setImageWidth(img12_1, TABLE_WIDTH);
    };
    cell12_1.appendChild(img12_1);
    cell12_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell13_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 14
    var row14 = table.insertRow();
    var cell14_1 = row14.insertCell();
    cell14_1.textContent = "Row 14 text";
    cell14_1.style.minHeight = "20px"; // Minimum row height
    ...
    img15_1.onload = function() {
        setImageWidth(img15_1, TABLE_WIDTH);
    };
    cell15_1.appendChild(img15_1);
    cell15_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell16_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 17
    var row17 = table.insertRow();
    var cell17_1 = row17.insertCell();
    cell17_1.textContent = "Row 17 text";
    cell17_1.style.minHeight = "20px"; // Minimum row height
    ...
    img18_1.onload = function() {
        setImageWidth(img18_1, TABLE_WIDTH);
    };
    cell18_1.appendChild(img18_1);
    cell18_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell19_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 20
    var row20 = table.insertRow();
    var cell20_1 = row20.insertCell();
    cell20_1.textContent = "Row 20 text";
    cell20_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell21_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 22
    var row22 = table.insertRow();
    var cell22_1 = row22.insertCell();
    cell22_1.textContent = "Row 22 text";
    cell22_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell23_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 24
    var row24 = table.insertRow();
    var cell24_1 = row24.insertCell();
    cell24_1.textContent = "Row 24 text";
    cell24_1.style.minHeight = "20px"; // Minimum row height
    ...
    cell28_1.style.minHeight = "20px"; // Minimum row height
    
    // Row 29
    var row29 = table.insertRow();
    var cell29_1 = row29.insertCell();
    cell29_1.textContent = "Row 29 text";
    cell29_1.style.minHeight = "20px"; // Minimum row height
});
